...
При выборе индивидуальных непереносимостей, поиск рецептов всегда будет осуществляться с учетом этого параметра (при поиске рецептов по ингредиентам не учитывается).
Выбор предпочитаемых единиц измерения учитывается при просмотре рецепта
